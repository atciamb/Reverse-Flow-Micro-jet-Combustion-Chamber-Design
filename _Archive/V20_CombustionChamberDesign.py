...
class MicroJetCombustor:
    ...
    def mechanical_geometry(self):
        ...
        tau_min   = self.DESIGN_PARAMS.get('tau_min_s', 0.002)
        L_D_min   = self.DESIGN_PARAMS.get('L_D_min',   0.70)
    ...
    def get_cad_geometry(self):
        return {
            "metadata": {
                ...
                "generated_by": "V20_CombustionChamberDesign.py",
    ...
    def stability_checks(self):
        ...
        Pr     = 0.72
        d_jet_m = d_pri_out_m
        Re_imp  = rho_pri * V_jet_pri * d_jet_m / mu_gas if mu_gas > 0 else 0.0
...
def print_report(res, inputs):
    ...
    print("   KJ66-Style Architecture  |  Rev 20 — Thermal, Vaporizer Physics, Dome Radiation")
    print("=" * W)
...
if __name__ == "__main__":
    ...
    print("  KJ66-style Micro-Jet  |  Rev 20")
    print("─" * 65)
    print()
